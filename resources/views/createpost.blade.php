...
<body>
    ...
    <form class="w-2/3 mx-auto mt-5" method="POST" action="/savepost">
        @csrf
        <h2 class="mb-5 text-2xl font-bold">Let's create a post</h2>
        <div class="mb-5">
